...
---
:::tip 观前提醒
请将微软账号二次验证（2FA）打开，防止被刷黑卡，被盗号申诉不会解封<br>
被盗Token后请立即去xbox官网打开禁止进入多人游戏，并一直挤号来降低损失<br>
...
![找到铁砧](https://i0.hdslb.com/bfs/new_dyn/7b5b3823bb0c580364a99b93dad965e9592616376.png)

**找到铁砧**

![处罚记录界面](https://i0.hdslb.com/bfs/new_dyn/1f3cbb7cbdf8151694bf0b0d39a6d99e592616376.png)
...
![安全警报示例](https://i0.hdslb.com/bfs/new_dyn/05b586482954c4b20d49c761cb9fb7e6592616376.png)
...
![Cheating封禁示例](https://i0.hdslb.com/bfs/new_dyn/ca353a83c0b8f8b41cf70a32e2a21975592616376.png)
...
![Boosting示例](https://i0.hdslb.com/bfs/new_dyn/46c88ab05fb4dcf171f152f73f570d2e592616376.png)
...
![Skyblock Boosting示例](https://i0.hdslb.com/bfs/new_dyn/52a3655fd0482976aff6a62efd55ea99592616376.png)

主要由于收c，Dupe物品，Macro等导致，通常会伴随Wipe，该类型主要有90天/360天，详细请参考最后一条

Skyblock Boosting<span style="color:#ee230d">记入封禁历史</span>，据大多数人说不会禁赛

## ➤ 极端聊天违规行为

![极端聊天违规示例](https://i0.hdslb.com/bfs/new_dyn/ae941a8f406d14b48b3a5ff0cbbf29ff592616376.png)

这个一般由于你的禁言黑历史太多导致的，但有时候发个IP也能爆，亦或者是发一些敏感词汇，*~~爆率相当高~~*，具体时长没有参考文献，这个一般是看管理员心情

## ➤ 违规ID

![违规ID示例](https://i0.hdslb.com/bfs/new_dyn/59bdcae7921673a76e99d0b1ad4062c9592616376.png)
...
![违规建筑封禁示例](https://i0.hdslb.com/bfs/new_dyn/694b4bd427d331ee10e1b40bdcb9802b592616376.png)
...
建筑Ban的时长机制可能和Cheating和Boosting类似，但<span style="color:#ee230d">不会触发竞技类游戏禁令</span>

## ➤ 跨队联合（违规组队）

![跨队联合示例](https://i0.hdslb.com/bfs/new_dyn/aecde8a50df8265008392990062cff88592616376.png)

在Solo或者Team模式跟其他队成员跨队联合（这个一般查的没这么严，不刻意跨队联合就没事）

违规组队的封禁时长在3到30天不等，可能也有时间更长的处罚

## ➤ 违规皮肤/披风

![违规皮肤示例](https://i0.hdslb.com/bfs/new_dyn/7f73b7885d34f9ebfff124ec9abafa15592616376.png)
...
![删数据申请示例](https://i0.hdslb.com/bfs/new_dyn/d3b54db2cfb36d691d8cea4de4c6684d592616376.png)

这个是自己申请的，不做过多解释，参考链接：https://hypixel.net/data-request

## ➤ 退款Ban

![退款Ban示例](https://i0.hdslb.com/bfs/new_dyn/efb6119b489d89ed637aa1ef186fb1e9592616376.png)

一般由于用黑刀（什么是黑刀我也不懂，自己查）充值，商店退款导致的

## ➤ 竞技类游戏禁令

![竞技类游戏禁令示例](https://i0.hdslb.com/bfs/new_dyn/834911c8ff3a48a5e936362f0e0d809c592616376.png)

触发竞技类游戏禁令无法游玩~~Tournaments（已删除）~~, UHC Champions, Mega Walls, and The Pit，~~也不能用Ranked Skywars特效（在sw更新后取消了）~~
...
<span style="color:#ee230d">根据经验观察，一个存档中，同一个账号获得两次Cheating Ban通常就会wipe，但是如果这个档上有5个玩家，每个人都被Cheating ban过一次，档不会wipe，据此来看他是以记录单个账号处罚次数为依据</span>

**同时，当wipe出现时，主要涉及玩家会被账号封禁，其余玩家视情况可能会被发送安全警报而非封禁处罚，同时在wipe后下次登录时收到一本书告知wipe，如下：**

![Wipe提示书](https://i0.hdslb.com/bfs/new_dyn/4c3fd1bb1fb1960c1ac4d5ac5fca1182592616376.png)

同时聊天框还会出现：

![聊天框提示](https://i0.hdslb.com/bfs/new_dyn/e77d0fbbde4d7ec601d8e3b03ab17174592616376.png)
...
![举报性禁言示例](https://i0.hdslb.com/bfs/new_dyn/09141249d36a13b780d8f248afb2b4d4592616376.png)
...
![轻微违规示例](https://i0.hdslb.com/bfs/new_dyn/3e7549ab021d4ec9cdc026adfb59261d592616376.png)
...
![严重违规示例](https://i0.hdslb.com/bfs/new_dyn/d42cc63ceb507881f4f5fe912132ef47592616376.png)
...
1. Q：up主问一下如果是在18年一月被ban计算在以后ban吗？
   A：官网上面关于禁赛的介绍是18年及以后的

2. Q：为啥我裸进也会被ban啊,还是30天大礼包
   A：这是作弊处罚，一般情况下是被盗号了，或者说是使用了违规mod进服被反作弊直接ban了，这里提醒大家不要使用部分生电客户端进服有可能引发误判

3. Q：我想去申诉它又说您的关联帐户上没有有效的惩罚，请确认您链接的帐户正确无误
   A：检查论坛账号绑定的MC账号是否为所需申诉的MC账号

4. Q：如果开G被封号，账号会不会被hyp给回档或者清档？
   A：不会

5. Q：skyblock如果被wipe了 是只wipe犯事的Profile还是把一个号上所有的Profile全部wipe
   A：犯事的档死掉，其他没事

6. Q：我前不久被误封后去hypixel论坛申诉，我把系统资源管理器后台所有程序进程和系统任务栏 游戏窗口标题栏完整的一秒内的封禁截图都上传了，官方还不承认是自己的反作弊问题导致我被误封
   A：官方只会自动回复，不要抱有幻想

7. Q：它下面写着“请注意，如果该帐户出现其他安全警报，则可能会被网络永久禁止”这样还能开加速器吗
   A：可以的，注意不要频繁换IP作死就行

8. Q：up，我想问问为了防止第二次被ban，我是不是应该尽量用正规付费加速器或者加速IP，加速器有什么推荐吗
   A：这样做似乎没啥用，正常使用不要作死就行

**2024.7.29由YZ_Ljc_撰写**

**2025.6.27由YZ_Ljc_最后一次修正**
